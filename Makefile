...
build/utils.o: src/utils.c
	nice gcc ${CFLAGS_INT} -c -o $@ $<
fimfar: build/ioapi.o build/pdjson.o build/build.o build/search.o build/fimfar.o build/multi.o build/ff-build.o
	nice gcc $(OPT_INT) $(CFLAGS) $(LDFLAGS) -o fimfar -Wall -Wextra -Wno-switch build/pdjson.o build/ioapi.o build/build.o build/search.o build/fimfar.o build/multi.o build/ff-build.o
clean:
	rm build/*
rebuild: db
